  ...
  return (
    <div className="mx-auto w-full max-w-full px-6 lg:px-0">
      ...
      <div className="mb-8 grid grid-cols-1 gap-x-6 sm:grid-cols-2">
        {INSIDER_ITEMS.map(i => (
          <div key={i} className="flex items-center gap-4 border-b border-[#d4d4d4] px-2 py-4">
            <span className="text-md self-start font-bold text-orange-500">{i + 1}</span>
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                <div className="rounded-sm bg-orange-100 px-1.5 py-0.5 text-sm font-medium text-orange-600">취업</div>
                <div className="text-md truncate font-medium text-gray-900">본사의 감작스런 해고통보</div>
              </div>
            ...
            <div className="flex flex-col items-center rounded-lg bg-gray-100 p-2">
              <span className="text-sm font-bold text-gray-600">37</span>
      ...
      {/* 토론 게시판 섹션 */}
      <h2 className="mb-4 text-xl font-bold">토론 게시판</h2>
      ...
      {/* 힐링추천 섹션 */}
      <h2 className="mb-4 mt-10 text-xl font-bold">힐링추천</h2>
      <div className="grid grid-cols-2 gap-5">
