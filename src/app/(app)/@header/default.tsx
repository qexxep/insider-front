        ...
        <div className="flex max-w-sm flex-1 items-center justify-center px-4">
          <div className="relative flex h-full w-full items-center">
            ...
            <Input
              ...
              className="h-8 rounded-full border-primary pl-10 focus:border-2 focus-visible:ring-0 focus-visible:ring-offset-0"
            />
          </div>
        </div>
        {/* 우측 */}
...
async function HotTopics() {
  ...
  return (
    <div className="flex min-w-[300px] items-center justify-between">
      ...
      <Icons.arrowBigUp className="h-4 w-4 fill-primary text-primary" />
    </div>
  );
}
